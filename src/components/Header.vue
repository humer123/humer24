...
const FacebookLink = 'https://www.facebook.com/homer.godinez.5/';
const LinkedinLink = 'https://www.linkedin.com/onboarding/start/people-you-may-know/new/';
const GithubLink = 'https://github.com/humer123';
        ...
        <nav class="mx-auto max-w-screen-xl px-12 py-4">
            <div class="flex flex-row items-center justify-between">
                <router-link to="/" class="flex flex-col">
                    <h1 class="font-bold text-xl">Humer Godinez</h1>
                    <p class="font-light text-lg text-gray-600">@humergodinez</p>
                </router-link>
